  ...
  const resolveRequest = async (
    ...
    try {
      ...
      if (!response.ok) {
        ...
        throw new Error(
          `Failed to update leave: ${response.status}`,
        )
      }
    ...
    <main className="admin-shell">
      <aside className="admin-sidebar">
        ...
        <div className="admin-sidebar-footer">
          <button
            onClick={() => showNotice('Settings page opened.')}
            type="button"
          >
            ⚙ <span>Settings</span>
          </button>
          ...
          <div className="admin-user">
            <div className="admin-avatar avatar-green">NP</div>
            ...
            <button
              ...
              onClick={() => showNotice('Account menu opened.')}
              type="button"
            >
              •••
            </button>
      ...
      <section className="admin-content">
        <header className="admin-topbar">
          <button
            ...
            onClick={() =>
              showNotice('Navigation menu opened.')
            }
            type="button"
          >
            ☰
          ...
          <div className="admin-top-actions">
            <button
              ...
              onClick={() =>
                showNotice('Employee search opened.')
              }
              type="button"
            >
            ...
            <button
              ...
              onClick={() =>
                showNotice('You have 3 new notifications.')
              }
              type="button"
            >
              ♧<i />
            ...
            <button
              ...
              onClick={() => showNotice('Profile opened.')}
              type="button"
            >
              NP
            </button>
  ...
  return (
    <>
      <div className="admin-heading">
        <div>
          <p className="admin-eyebrow">FRIDAY, 22 AUGUST</p>
          <h1>
            Good morning, Neha <span>👋</span>
          </h1>
        ...
        <button
          ...
          onClick={() =>
            showNotice('Add employee form opened.')
          }
          type="button"
        >
          ＋ Add employee
      ...
      <section className="admin-panel attendance-panel">
        <div className="admin-panel-heading">
          <div>
            ...
            <p>
              Latest employee check-ins and attendance status.
            </p>
          </div>
      ...
      <PageHeading
        ...
        action={
          <button
            className="admin-primary"
            onClick={() =>
              showNotice('Leave report exported.')
            }
            type="button"
          >
            Export requests
      ...
      <PageHeading
        ...
        action={
          <button
            className="admin-primary"
            onClick={() =>
              showNotice('Payroll report exported.')
            }
            type="button"
          >
            Export payroll
          ...
          {payrollData.map((employee) => (
            ...
            >
              <div className="employee-cell">
                <span
                  className={`request-avatar ${employee.color}`}
                >
                  {employee.initials}
                </span>
...
function AttendanceRow({
  ...
  return (
    <div className="attendance-row">
      <div className="employee-cell">
        <span className={`request-avatar ${color}`}>
          {initials}
        </span>
